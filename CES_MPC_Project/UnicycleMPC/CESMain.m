...
Ts = 0.336%0.396; %REFTRACK USE 0.425; IG USE 0.425;
PH = 10;
CH = 4;
wPath = [0];
...
%%%%%%%%%%%%%%%%%%%%%% Path Tracking (Trajectory Reference/Guesses) %%%%%%%%%%%%%%%%%
%
